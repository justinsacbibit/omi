...
module.exports = function(app) {
  ...
  app.route('/api/v1/local-transactions')
    ...
    .post(users.requiresToken, localTransactions.attachOwer, localTransactions.canCreate, localTransactions.create);
  ...
  app.route('/api/v1/local-transactions/:localTransactionId')
    ...
    .put(users.requiresToken, localTransactions.attachOwer, localTransactions.hasAuthorization, localTransactions.update)
    .delete(users.requiresToken, localTransactions.attachOwer, localTransactions.hasAuthorization, localTransactions.delete);
